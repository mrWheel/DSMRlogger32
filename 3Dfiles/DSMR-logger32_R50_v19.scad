...
cutoutsLid =  [
     ...
     //-- if no oled screen make next array a comment ---
...
if (printOledStand)
{
  if (!oled_13_inch)
  {
    ...
    translate([-15,125,0])
    {
      ...
      translate([0,0,0])                 color("green") cube([10.5,3,2]);   // stand
      translate([0,oledPcb09Width-3,0])  color("green") cube([10.5,3,2]);   // stand
      
      translate([0,0,0])                 color("blue")  cube([3,8,2]);      // bigger
      translate([0,oledPcb09Width-8,0])  color("blue")  cube([3,8,2]);      // bigger
      
      translate([-1.5,1.5,0])              color("black") cube([3,1.5,1.5]);  // centreer nop
      translate([-1.5,oledPcb09Width-3,0]) color("red")   cube([3,1.5,1.5]);  // centreer nop
      //-- meet balk
      //translate([-3,2,0]) cube([2,oledPcb13Width-4.0, 2]);
    }
  }
  else  //-- 1.3"
  {
    ...
    translate([-15,125,0])
    {
      ...
      translate([0,5,0])                 color("green") cube([10.5,3,2]);   // stand
      translate([0,oledPcb13Width-8,0])  color("green") cube([10.5,3,2]);   // stand
      
      translate([0,0,0])                 color("blue")  cube([3,8,2]);      // bigger
      translate([0,oledPcb13Width-8,0])  color("blue")  cube([3,8,2]);      // bigger
      
      translate([-1,1.5,0])              color("black") cube([3,1.5,1.5]);  // centreer nop
      translate([-1,oledPcb13Width-3,0]) color("red")   cube([3,1.5,1.5]);  // centreer nop
      //-- meet balk
      //translate([-3,2,0]) cube([2,oledPcb13Width-4.0, 2]);
    }
  }
